...
Logo tiles render at roughly **140×44px**. SVG is preferred (scales crisply at any size); PNG with a transparent background also works — export at **2x** (≈280×88px) for retina sharpness. Logos display in grayscale and turn full-color on hover.
